...
python train.py --data_path="DATAPATH" --batch_size=BATCHSIZE --n_radius=RADIUS --max_m=THETA --learning_rate=0.005 --weight_decay=0.0005 --num_epochs=EPOCHS --lr_decay_rate=0.5 --lr_decay_schedule=20
