...
python train.py --data_path="DATAPATH" --batch_size=BATCHSIZE --rotate=ROTATE --learning_rate=0.01 --weight_decay=0.0 --num_epochs=EPOCHS --lr_decay_rate=0.5 --lr_decay_schedule=20 --metric_type=METRICTYPE --restore=RESTORE --save=SAVE
